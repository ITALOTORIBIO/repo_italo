...
namespace nUnitTest.Driver
{
    public class DriverFactory
    {
        ...
        public void getDriverBrowser(String browser)
        {
            switch (browser)
            {
                case "chrome":
            ...
            genericDriver.initDriver();
        }

        public void tearDown()
        {
            genericDriver.destroyDriver();
        }
        ...
        public IWebDriver CreateInstance(BrowserType browserType, string hubUrl)
        {
